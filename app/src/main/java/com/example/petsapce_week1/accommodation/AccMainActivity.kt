...
//        Log.d("roomBeforeID",roomBeforeID.toString())
        ...
        val roomId: Long = intent.getLongExtra("content", -1L)
        Log.d("roomID", roomId.toString())

    /*    if (roomBeforeID != null) {
            rommIDTotal = roomBeforeID.toLong()
        }*/
        rommIDTotal = roomId
        rommIDTotal = roomBeforeID.toLong()


//        Log.d("rommID",rommIDTotal.toString())


        /*  if(!roomBeforeID.equals("-1") || roomBeforeID ){

          }*/

        // =================== 백엔드 연동 부분 =====================
        //홈화면 연결 후 roomId 받아오면 반영!
        api.getRoomDetail(accessTokenPost,rommIDTotal)
                    ...
                    if (body != null) {
                        ...
                        binding.btnHeartBefore.setOnClickListener {
                            ...
                            if (if1Checked == 0) {
                                ...
                                if1Checked = 1
                                // 상진쓰랑 할것
                                api.postLikes(accessTokenPost, roomId)
                                    .enqueue(object : Callback<AccomodationData> {
                                        override fun onResponse(
                                            call: Call<AccomodationData>,
                                            response: Response<AccomodationData>
...
//                        .into(binding.frameFacility.imgFac6)
        ...
        binding.btnReserve.setOnClickListener {
            ...
            apiReservation.postReservation(
                accessTokenPost,
                jsonParams = ReservationUserData(2, 1, "2023-02-16", "2023-02-17"),
                1
